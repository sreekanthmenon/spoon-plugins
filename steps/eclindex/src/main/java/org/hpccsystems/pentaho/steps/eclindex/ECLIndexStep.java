...
public class ECLIndexStep extends BaseStep implements StepInterface {
    ...
    public boolean processRow(StepMetaInterface smi, StepDataInterface sdi) throws KettleException {
        ...
        index.setOverwrite(meta.getOverwrite());
        if(isDuplicate.equals("Yes")){
            index.setIndex(meta.getIndex());
            index.setNewindexfile(meta.getNewindexfile());
        }else{
            index.setBaserecset(meta.getBaserecset());
            index.setKeys(resultListToString(meta.keys));
