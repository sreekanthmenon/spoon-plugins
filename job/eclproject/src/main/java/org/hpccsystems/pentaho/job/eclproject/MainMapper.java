...
public class MainMapper {
	 ...
	 */
	private void addChildControls(Composite parentComp) {
		...
		buildExpressionPanel(parentComp);	// Add the widgets needed to build a Expression Panel
	...
	public void buildExpressionPanel(Composite parentComp){
