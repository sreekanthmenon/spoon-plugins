 ...
 * @author ChambersJ
 */
public class ECLML_ToFieldDialog extends ECLJobEntryDialog{//extends JobEntryDialog implements JobEntryDialogInterface {

    private ECLML_ToField jobEntry;
    ...
    public ECLML_ToFieldDialog(Shell parent, JobEntryInterface jobEntryInt, Repository rep, JobMeta jobMeta) {
        super(parent, jobEntryInt, rep, jobMeta);
        jobEntry = (ECLML_ToField) jobEntryInt;
        if (this.jobEntry.getName() == null) {
            this.jobEntry.setName("ToField");
        }
    }
    ...
    public JobEntryInterface open() {
        ...
        shell.setText("Define an ECL ToField");
