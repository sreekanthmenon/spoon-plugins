 ...
 * @author ChalaAX
 */
public class ECLSaltDataProfilingDialog extends JobEntryDialog implements JobEntryDialogInterface {
    private ECLSaltDataProfiling jobEntry;
    ...
    public ECLSaltDataProfilingDialog(Shell parent, JobEntryInterface jobEntryInt, Repository rep, JobMeta jobMeta) {
        super(parent, jobEntryInt, rep, jobMeta);
        jobEntry = (ECLSaltDataProfiling) jobEntryInt;
