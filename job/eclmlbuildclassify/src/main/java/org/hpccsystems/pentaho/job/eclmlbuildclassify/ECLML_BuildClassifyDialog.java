 ...
 * @author ChambersJ
 */
public class ECLML_BuildClassifyDialog extends ECLJobEntryDialog{//extends JobEntryDialog implements JobEntryDialogInterface {
    ...
    public JobEntryInterface open() {
        ...
        shell.setText("Define a Classification - Learn");
