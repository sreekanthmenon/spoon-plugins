...
@SpoonPlugin(id = "spoonECLConfig", image = "")
@SpoonPluginCategories({"spoon"})
public class ECLConfigSpoonPlugin implements SpoonPluginInterface {

  public ECLConfigSpoonPlugin(){
  }
  ...
  public void applyToContainer(String category, XulDomContainer container) throws XulException {
    ...
    if(category.equals("spoon")){
      container.loadOverlay("org/pentaho/di/plugins/perspectives/eclconfig/res/spoon_overlay.xul");
      container.addEventHandler(new ECLConfigPerspectiveHandler());
    }
  }
